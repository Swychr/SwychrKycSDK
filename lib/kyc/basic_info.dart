...
class BasicInfoScreen extends StatefulWidget {
  ...
  BasicInfoScreen({Key? key, this.email, this.api_key, this.primaryColor})
      : super(key: key);
  @override
  _PaytmState createState() => _PaytmState();
}

class _PaytmState extends State<BasicInfoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: appBarCommonToHome(context, "Basic Information"),
      body: _bodyItem(),
    );
  }
                ...
                children: <Widget>[
                  ...
                  child: IntlPhoneField(
                    ...
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(10),
                        borderSide: BorderSide(color: LightColor.kPrimaryColor),
                  ...
                  Padding(
                      ...
                      child:  DropdownButtonFormField2<String>(
                          ...
                          decoration: InputDecoration(
                            ...
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(10),
                              borderSide:  BorderSide(color: LightColor.grey, width: 1.0),
                  ...
                  RoundedButton(
                    ...
                    press: () {
                      ...
                      }else if (zipController!.text!  == ""){
                        ShowToastMsg("Please enter zip code");

                      }
                      else {
                        print (phoneNo);
                        showConfirmationAlert(context,nameController.text, phoneNo!, gender, dobController.text, addressController!.text, address2Controller!.text!, cityController!.text!, zipController!.text!, country_name, phone_code, country_iso_code, widget.email!, widget.primaryColor!, widget.api_key!);
  ...
  Future<void> submitBasicInfoRequest(BuildContext context, String name, String phoneNo, String gender, String dob, String address, String street_address, String city, String zip_code, String country_name, String mobile_code, String country_iso_code, String email, Color primaryColor, String api_key) async {
    await pd!.show();
    final body = {
      "email": email,
      "name": name,
